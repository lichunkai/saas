...
/**
 * This is the model class for table "zh_order_rent_followup".
 *
 ...
 */
class OrderRentFollowupGii extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['order_id', 'd_id', 'of_notify_user', 'c_id', 'u_id', 'auth_uid', 'auth_rid', 'auth_sid', 'auth_aid', 'auth_baid', 'is_del'], 'integer'],
