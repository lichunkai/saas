...
use backend\models\Salary_config_gongzi;
 ...
 * 学区控制器
 */
class Salary_config_gongziController extends AuthController
{
    /**
     * @inheritdoc
     */
    ...
    public function actionIndex()
    {
        ...
        $row = Salary_config_gongzi::find()->where(['is_del'=>0,'company_id'=>$this->_user['company_id']]);
    ...
    public function actionAdd()
    {
        ...
        if (yii::$app->request->isPost && !empty($post)) {
            $Salary_config_gongzi = new Salary_config_gongzi();
            $result = $Salary_config_gongzi->updateSalary_config_gongzi($post, $this->_user);
            if ($result) {
