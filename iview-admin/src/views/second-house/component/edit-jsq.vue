                ...
                <TabPane label="贷款计算器">
                    <Row :gutter="20">
                        ...
                        <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="100">
                            ...
                            <FormItem label="贷款成数："
                                      v-if="formValidate.loan_type!=='组合贷款'"
                                      prop="mortgage_number">
                            ...
                            <FormItem label="商贷利率："
                                      v-if="formValidate.loan_type=='组合贷款' || formValidate.loan_type=='商业贷款'"
                                      prop="business_interestRate">
                                <Row>
                                    <Col :lg="16" :md="16">
                                    <Select v-model="formValidate.business_interestRate" @on-change="selectChange_s">
                                        <Option v-for="item in businessInterestRate" :value="item.value"
                                                :key="item.value">{{
                                            item.label }}
                                        </Option>
                                    </Select>
                                    ...
                                    <Col :lg="8" :md="8">
                                    <Input v-model="formValidate.business_interestRateValue"><span
                                        slot="append">%
                                </span></Input>
                                    </Col>
                                </Row>
                            </FormItem>
                            <FormItem label="公积金利率："
                                      v-if="formValidate.loan_type=='组合贷款' || formValidate.loan_type=='公积金贷款'"
                                      prop="accumulationFund_lilv">
                                <Row>
                                    <Col :lg="16" :md="16">
                                    <Select v-model="formValidate.accumulationFund_lilv" @on-change="selectChange_g">
                                        <Option v-for="item in accumulationFundLilv" :value="item.value"
                                                :key="item.value">{{
                                            item.label }}
                                        </Option>
                                    </Select>
                                    ...
                                    <Col :lg="8" :md="8">
                                    <Input v-model="formValidate.accumulationFund_lilvValue"><span
                                        slot="append">%</span>
                                    </Input>
                                    </Col>
                                </Row>
                            ...
                            <FormItem label="公积金贷款额：" v-if="formValidate.loan_type=='组合贷款'"
                                      prop="accumulationFund_loan">
                        ...
                        <Row>
                            ...
                            <Col :lg="12" :md="12" style="margin-top: 10px;padding:0 10px"
                                 v-if="repayment_type!=='等额本金' && formValidate.loan_type!=='组合贷款'">
                            <span>首付： {{f_shoufu}}</span>
                            </Col>
                            <Col :lg="12" :md="12" style="margin-top: 10px"
                                 v-if="repayment_type!=='等额本金'">
                ...
                <TabPane label="税款计算器">
                    <Row :gutter="40">
                        ...
                        <Form ref="formValidate2" :model="formValidate2" :rules="ruleValidate2" :label-width="120">
                            ...
                            <FormItem label="计征方式：" v-if="house_type=='二手房'" prop="Levy_type">
                                <Select v-model="formValidate2.Levy_type">
                                    <Option v-for="item in jizheng" :value="item.value" :key="item.value">{{
                                        item.label }}
                                    </Option>
                                </Select>
                            </FormItem>
                            <FormItem label="交易差额："
                                      v-if="house_type=='二手房' && formValidate2.Levy_type=='差价'"
                                      prop="house_Oprice">
                            ...
                            <FormItem label="房产性质：" v-if="house_type=='二手房'" prop="houseProperty_type">
                                <Select v-model="formValidate2.houseProperty_type">
                                    <Option v-for="item in xingzhi" :value="item.value" :key="item.value">{{
                                        item.label }}
                                    </Option>
                                </Select>
                            </FormItem>
                        ...
                        <!--<transition enter-active-class="animated zoomInLeft" leave-active-class="animated zoomOutRight">-->
                            ...
                            <Row>
                                <Col :lg="12" :md="12" style="margin-bottom: 10px">
                                房款总款：{{fangkuan}}
                                </Col>
                                <Col :lg="12" :md="12" style="margin-bottom: 10px">
                                合计：{{heji}}
...
//          等额本息
                ...
                if(this.repayment_type==='等额本息'){
                    ...
                    if(this.formValidate.loan_type==='商业贷款'){
                        ...
                        this.f_yuegong=(this.f_daikuan*(this.formValidate.business_interestRateValue/1200)*Math.pow((1+this.formValidate.business_interestRateValue/1200),loanYear))
                        ...
                        this.f_shoufu=((this.formValidate.loan_total*10000-this.f_daikuan)/10000).toFixed(2)+"万";
                        this.f_daikuan=(this.f_daikuan/10000).toFixed(2)+"万";
                    ...
                    //公积金贷款
                        ...
                        this.f_daikuan=this.formValidate.loan_total*10000*this.formValidate.mortgage_number;
                        this.f_yuegong=(this.f_daikuan*(this.formValidate.accumulationFund_lilvValue/1200)*Math.pow((1+this.formValidate.accumulationFund_lilvValue/1200),loanYear))
                    ...
                    //组合贷款
                        ...
                        this.f_daikuan=this.formValidate.business_total*10000+this.formValidate.accumulationFund_loan*10000;
                        this.f_yuegong=this.formValidate.business_total*10000*
                            (this.formValidate.business_interestRateValue/1200)*Math.pow((1+this.formValidate.business_interestRateValue/1200),loanYear)
                            /(Math.pow((1+this.formValidate.business_interestRateValue/1200),(loanYear))-1)+
                            this.formValidate.accumulationFund_loan*10000*
                                (this.formValidate.accumulationFund_lilvValue/1200)*Math.pow((1+this.formValidate.accumulationFund_lilvValue/1200),loanYear)
                                /(Math.pow((1+this.formValidate.accumulationFund_lilvValue/1200),(loanYear))-1);
                        this.f_lixi=loanYear*this.f_yuegong-this.f_daikuan;
//列表
                        this.data2=[];
                        for(let i=0;i<loanYear;i++){
                            let  residualPrincipal=this.f_daikuan;
                            let reimbursementPrincipal=
                                (this.formValidate.accumulationFund_loan*10000*this.formValidate.accumulationFund_lilvValue/1200*
                                    Math.pow((1+this.formValidate.accumulationFund_lilvValue/1200),(i))/
                                    (Math.pow((1+this.formValidate.accumulationFund_lilvValue/1200),(loanYear))-1)
                                )+(this.formValidate.business_total*10000*this.formValidate.business_interestRateValue/1200*
                                    Math.pow((1+this.formValidate.business_interestRateValue/1200),(i))/
                                    (Math.pow((1+this.formValidate.business_interestRateValue/1200),(loanYear))-1)
                                );
                            if(i==0){
...
//            等额本金
                    ...
                    **/
                    ...
                    if(this.formValidate.loan_type==='商业贷款'){
                        ...
                        this.f_daikuan=this.formValidate.loan_total*10000*this.formValidate.mortgage_number;
                        this.f_fristyuegong=(this.f_daikuan/loanYear)+this.f_daikuan*this.formValidate.business_interestRateValue/1200;
                        this.f_lixi=((this.f_daikuan/loanYear+this.f_daikuan*this.formValidate.business_interestRateValue/1200)+
                            this.f_daikuan/loanYear*(1+this.formValidate.business_interestRateValue/1200))/2*loanYear-this.f_daikuan;
                        ...
                        for(let i=0;i<loanYear;i++){
                            this.$set(this.data2,i,{
                                ...
                                Interest:(
                                (this.f_daikuan- (this.f_daikuan/loanYear)*i)*(this.formValidate.business_interestRateValue/1200)).toFixed(2),
                                reimbursementPrincipal:(this.f_daikuan/loanYear).toFixed(2),
                                residualPrincipal:(this.f_daikuan- (this.f_daikuan/loanYear)*(i+1)).toFixed(2),
                            });
                        }
                        //结果显示
                        this.f_daikuan=this.f_daikuan/10000+"万";
                    ...
                    //公积金贷款
                        ...
                        this.f_daikuan=this.formValidate.loan_total*10000*this.formValidate.mortgage_number;
                        this.f_fristyuegong=(this.f_daikuan/loanYear)+this.f_daikuan*this.formValidate.accumulationFund_lilvValue/1200;
                        this.f_lixi=((this.f_daikuan/loanYear+this.f_daikuan*this.formValidate.accumulationFund_lilvValue/1200)+
                            this.f_daikuan/loanYear*(1+this.formValidate.accumulationFund_lilvValue/1200))/2*loanYear-this.f_daikuan;
                        this.f_huankuan=(this.f_daikuan+this.f_lixi)/10000;
                        this.f_dijian=(this.f_daikuan/loanYear)*(this.formValidate.accumulationFund_lilvValue/1200);
                        //列表
                        this.data2=[];
                        for(let i=0;i<loanYear;i++){
                            this.$set(this.data2,i,{
                                ...
                                monthFor:(this.f_fristyuegong-this.f_dijian*i).toFixed(2),
                                Interest:(
                                    (this.f_daikuan- (this.f_daikuan/loanYear)*i)*(this.formValidate.accumulationFund_lilvValue/1200)).toFixed(2),
                                reimbursementPrincipal:(this.f_daikuan/loanYear).toFixed(2),
                                residualPrincipal:(this.f_daikuan- (this.f_daikuan/loanYear)*(i+1)).toFixed(2),
                            });
                        }
                    ...
                    //组合贷款
                        ...
                        this.f_daikuan=this.formValidate.business_total*10000+this.formValidate.accumulationFund_loan*10000;
                        //首月月供
                        this.f_fristyuegong=(this.formValidate.business_total*10000/loanYear)+this.formValidate.business_total*10000*this.formValidate.business_interestRateValue/1200+
                            (this.formValidate.accumulationFund_loan*10000/loanYear)+this.formValidate.accumulationFund_loan*10000*this.formValidate.accumulationFund_lilvValue/1200;
                        //总利息               总利息=〔(总贷款额÷还款月数+总贷款额×月利率)+总贷款额÷还款月数×(1+月利率)〕÷2×还款月数-总贷款额
                        this.f_lixi=((this.formValidate.business_total*10000/loanYear+this.formValidate.business_total*10000*this.formValidate.business_interestRateValue/1200)+
                            this.formValidate.business_total*10000/loanYear*(1+this.formValidate.business_interestRateValue/1200))/2*loanYear-this.formValidate.business_total*10000+
                            ((this.formValidate.accumulationFund_loan*10000/loanYear+this.formValidate.accumulationFund_loan*10000*this.formValidate.accumulationFund_lilvValue/1200)+
                                this.formValidate.accumulationFund_loan*10000/loanYear*(1+this.formValidate.accumulationFund_lilvValue/1200))/2*loanYear-this.formValidate.accumulationFund_loan*10000;
                        //总还款
                        this.f_huankuan=(this.f_daikuan+this.f_lixi)/10000;
                        //每月递减
                        this.f_dijian=(this.formValidate.business_total*10000/loanYear*this.formValidate.business_interestRateValue/1200)
                        +(this.formValidate.accumulationFund_loan*10000/loanYear*this.formValidate.accumulationFund_lilvValue/1200);
                        //列表
                        this.data2=[];
                        for(let i=0;i<loanYear;i++){
                            this.$set(this.data2,i,{
                                ...
                                monthFor:(this.f_fristyuegong-this.f_dijian*i).toFixed(2),
                                Interest:(
                                    (this.formValidate.accumulationFund_loan*10000- (this.formValidate.accumulationFund_loan*10000/loanYear)*i)*(this.formValidate.accumulationFund_lilvValue/1200)+
                                    (this.formValidate.business_total*10000- (this.formValidate.business_total*10000/loanYear)*i)*(this.formValidate.business_interestRateValue/1200)).toFixed(2),
                                reimbursementPrincipal:(this.f_daikuan/loanYear).toFixed(2),
                                residualPrincipal:(this.f_daikuan- (this.f_daikuan/loanYear)*(i+1)).toFixed(2),
                            });
                        }
