...
<template>
    <Row>
        ...
        <Row :gutter="10" style="margin-top: 10px">
            <Col>
            <Table :columns="columns1" :data="houseList" border script height="560"></Table>
            </Col>
        </Row>
        </Col>
    </Row>
        ...
        data() {
                    ...
                    },
                    {
                        ...
                        render: (h, params) => {
                            return h('Button', {
                                ...
                                on: {
                                    click: () => {
	                                    let argu = {houseId: params.row.house_uuid,saleType:params.row.order_type};
                                        this.$router.push({
                                            name: 'roomDetails',
                                            params: argu
                                        });
            ...
            getIndex() {
                ...
                if(this.$route.params.customer_type==1){
                    this.searchData.sale_type = 1;
                }
                if(this.$route.params.customer_type==2){
                    this.searchData.sale_type = 3;
                }
                this.searchData.dts_id=[this.customer.dts_id];
                this.searchData.mjqj=this.customer.xuqiumianji_min+'-'+this.customer.xuqiumianji_max;
