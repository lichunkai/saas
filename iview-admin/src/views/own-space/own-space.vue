                ...
                >
                    <FormItem label="用户姓名：" prop="name">
                        <div style="display:inline-block;width:150px;">
                            <Input v-model="userForm.name" readonly></Input>
                        </div>
                    </FormItem>
                    <FormItem label="用户手机：" prop="cellphone">
                        <div style="display:inline-block;width:150px;">
                            <Input v-model="userForm.cellphone" @on-keydown="hasChangePhone" readonly></Input>
                        </div>
    ...
    export default {
        ...
        methods: {
            ...
            saveEditPass () {
                this.$refs['editPasswordForm'].validate((valid) => {
                    if (valid) {
                        ...
                        this.$http.post(api_param.apiurl + 'login/editpwd',
                            {
                                'pwd': this.editPasswordForm.oldPass,
                                'new_pwd':this.editPasswordForm.newPass,
                            },
            ...
            init () {
                ...
                this.userForm.cellphone = Cookies.get('u_mobile');
                this.initPhone = Cookies.get('u_mobiles');
                this.userForm.company = '正弘环太湖集团'
                this.userForm.department = Cookies.get('dept_name');
            },
            cancelInputCodeBox () {
